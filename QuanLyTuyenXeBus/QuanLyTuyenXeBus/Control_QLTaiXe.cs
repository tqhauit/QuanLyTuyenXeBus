...
{
    public partial class Control_QLTaiXe : UserControl
    {
        public Control_QLTaiXe()
        {
            InitializeComponent();
        ...
        private void Control_QLTaiXe_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (txtMaTaiXe.Text == "")
            {
                MessageBox.Show("Vui lòng chọn tài xế muốn xóa");
            }
            else
            {
                Operation opr = new Operation();
                DialogResult dialogResult = MessageBox.Show("Bạn có chắc chắn muốn xóa tài xế "+txtMaTaiXe.Text, "Thông báo", MessageBoxButtons.YesNo);
                if (dialogResult == DialogResult.Yes)
                {
                    bool check = opr.xoaTaiXe(txtMaTaiXe.Text);
                    if (check == true)
                    {
                        LoadData();
                    ...
                    {
                        MessageBox.Show("Mã Tài Xế muốn xóa không tồn tại");
                    }
                }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (txtMaTaiXe.Text == "")
            {
                MessageBox.Show("Mã tài x61 không được để trống");
            }
            else
            {
                if (txtHoTen.Text == "")
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    tx.bangLai = txtBangLai.Text;
                                                    tx.maXe = cboMaXe.Text;
                                                    bool checkUpdate = opr.themTaiXe(tx);
                                                    if (checkUpdate == true)
                                                    {
                                                        LoadData();
